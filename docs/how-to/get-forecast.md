...
- `cnt`: A count of the number of data points returned (always 40 for a full 5-day forecast).
- `list[]`: The array containing the forecast data.
- `list[].dt_txt`: The forecasted date and time in text format (UTC).
- `city`: Contains metadata about the location, including sunrise, sunset, and timezone offset.

## Filtering by Day

Because the API returns 3-hour steps, if you just want to show the user a "Daily High/Low", you will need to aggregate this data on your client or backend.
...
// Output: [ '2024-05-09', '2024-05-10', '2024-05-11', '2024-05-12', '2024-05-13', '2024-05-14' ]
```
