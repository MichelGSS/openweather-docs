...
- **Current Weather** is updated across the system roughly every 10 to 15 minutes. 
- **Forecast Models** are computed in massive batch processes and updated every 3 to 6 hours.
